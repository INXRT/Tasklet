  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center relative z-10 p-4">
      ...
      >
        ...
        <p className="mt-8 text-center text-xs text-zinc-500 font-sans max-w-xs">
          By signing in, you agree to level up your <span className="text-zinc-300">Tasks</span>, <span className="text-zinc-300">Goals</span>, and <span className="text-zinc-300">Missions</span>.
        </p>
      </motion.div>
    </div>
  );
